...
const expected: Record<keyof typeof TABLES, string[]> = {
  ...
  drivers: ["FullName", "First Name", "Middle Name", "Last Name", "E-mail", "Phone Number", "Years Of Experience", "DOB", "Company Name (This is NOT the Insurance)", "CDL", "State", "CDL Expiration", "Gender", "Insurance", "Ninox_ID", "ID", "organization_id"],
  returns: ["Insurance", "Truck", "Driver Name", "Phone Number", "Return Date", "ID", "Ninox_ID", "organization_id"],
  ...
  trucks: ["truck_number", "dispatcher", "insurance", "vin", "make", "odometer_miles", "owner", "last_known_address", "model_year", "license_plate", "yard_location", "samsara_last_connected_at", "samsara_vehicle_id", "mechanic_status", "ID", "organization_id"],
};
...
Deno.test("metadata covers all 96 live reporting columns exactly", () => {
  let count = 0;
  ...
  assert(count === 96, `expected 96 fields, got ${count}`);
});
