...
2. Update every affected artifact:
   ...
   - `docs/html-reporting.md` and `skills/agent-reporting-html`, `skills/reporting-html-shadcn` (including `assets/report-ui.css`) for Grok/Cursor HTML report windows, required sections, or shared UI kit changes.
