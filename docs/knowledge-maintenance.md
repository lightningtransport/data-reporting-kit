...
2. Update every affected artifact:
   ...
   - `docs/html-reporting.md`, `apps/reporting-dashboard`, and `skills/agent-reporting-html`, `skills/reporting-html-shadcn` for Grok/Cursor HTML/dashboard windows, required sections, or UI kit changes.
