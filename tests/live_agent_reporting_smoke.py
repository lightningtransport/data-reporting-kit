...
status, _ = call([("report", "trucks"), ("limit", "1")], RESTRICTED_KEY)
...
status, trucks = call([("report", "trucks"), ("limit", "2")])
...
status, trucks2 = call([("report", "trucks"), ("limit", "2"), ("offset", "2")])
...
status, empty_page = call([("report", "trucks"), ("offset", "1000")])
