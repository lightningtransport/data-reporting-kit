...
- A Next.js + shadcn/ui reporting dashboard (`apps/reporting-dashboard`) for Grok Bot / Cursor agents, with Liquidaciones (weekly/monthly review, rankings, fuel-by-owner, KPIs), Out Schedule, Trucks Return, Diesel, a shared view menu, and evidence footers.
